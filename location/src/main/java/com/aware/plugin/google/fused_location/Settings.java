...
public class Settings extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onResume() {
        ...
        if (Aware.getSetting(getApplicationContext(), STATUS_GOOGLE_FUSED_LOCATION).length() == 0) Aware.setSetting(getApplicationContext(), STATUS_GOOGLE_FUSED_LOCATION, true);
        ...
        if (Aware.getSetting(getApplicationContext(), FREQUENCY_GOOGLE_FUSED_LOCATION).length() == 0) Aware.setSetting(getApplicationContext(), FREQUENCY_GOOGLE_FUSED_LOCATION, 300);
        ...
        if (Aware.getSetting(getApplicationContext(), MAX_FREQUENCY_GOOGLE_FUSED_LOCATION).length() == 0) Aware.setSetting(getApplicationContext(), MAX_FREQUENCY_GOOGLE_FUSED_LOCATION, 60);
        ...
        if (Aware.getSetting(getApplicationContext(), FALLBACK_LOCATION_TIMEOUT).length() == 0) Aware.setSetting(getApplicationContext(), FALLBACK_LOCATION_TIMEOUT, 20);
        ...
        if (Aware.getSetting(getApplicationContext(), LOCATION_SENSITIVITY).length() == 0) Aware.setSetting(getApplicationContext(), LOCATION_SENSITIVITY, 5);
        ...
        if (Aware.getSetting(getApplicationContext(), ACCURACY_GOOGLE_FUSED_LOCATION).length() == 0) Aware.setSetting(getApplicationContext(), ACCURACY_GOOGLE_FUSED_LOCATION, LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY);
